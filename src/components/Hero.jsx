...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            >
                <h2 className="text-green font-mono text-xl mb-4 tracking-widest">
                    BONJOUR, JE SUIS
                </h2>
                ...
                <button
                  ...
                  className="px-8 py-4 border border-green text-green rounded hover:bg-green/10 transition-all font-mono"
                >
                  Voir mes projets ↓
                </button>
            </motion.div>
